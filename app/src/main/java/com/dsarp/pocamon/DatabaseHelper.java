...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean registerUser(String username, String password) {
        ...
        // Close the DatabaseHelper connection
        db.close();
        // Return true if the insertion was successful (result != -1), otherwise false
        return result != -1;
    }
    ...
    public boolean updatePassword(String username, String newPassword) {
        ...
        // Return true if at least one row was affected (user exists and password was updated)
